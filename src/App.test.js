...
jest.mock("@chakra-ui/react", () => {
    ...
    return {
        ...
        Container: ({ children, ...props }) => (
            <Container
                {...props}
                className={"test-container " + props.className}
            >
                {children}
            </Container>
        ),
        ...
        FormLabel: ({ children, ...props }) => (
            <FormLabel
                {...props}
                className={"test-form-label " + props.className}
            >
                {children}
            </FormLabel>
        ),
    ...
    describe("When user is signed in", () => {
        beforeEach(() => {
            const user = {
                ...
                desc: "Admin User",
                profilePic:
                    "https://images.unsplash.com/photo-1544642058-1f01423e7a16",
            };
        ...
        it("should render Photo component immediately", async () => {
            ...
            await waitFor(async () => {
                expect(
                    await screen.getAllByRole("test-image").length
                ).toBeGreaterThan(0);
...
describe("Sign In", () => {
    ...
    it("should navigate to home page when user sign in successfully", async () => {
        ...
        await waitFor(async () => {
            ...
            expect(
                await screen.getByText("Kirana Islamadina")
            ).toBeInTheDocument();
            expect(
                await screen.getByText("Hi! I'm Kirana")
            ).toBeInTheDocument();
...
describe("Detail", () => {
    ...
    it("should render photo detail page by photo id", async () => {
        ...
        expect(
            container.querySelector(".detail-photo-page")
        ).toBeInTheDocument();
    });
